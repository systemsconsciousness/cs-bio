            ...
            >
              ...
              <div className="p-4 sm:p-6">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {/* Title */}
                  <h2 className="text-lg sm:text-xl font-bold text-foreground group-hover:text-accent transition-colors line-clamp-2">
                    {post.title}
                  </h2>
                  ...
                  {post.blog_tags && post.blog_tags.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {post.blog_tags.slice(0, 3).map((tag, index) => (
                        <span
                          key={index}
